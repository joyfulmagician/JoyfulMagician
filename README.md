...
<p align="justify">Hello, I'm an accomplished Full Stack Developer with a wealth of experience spanning eight years, specializing in both frontend and backend development. On the frontend, I've honed my skills in designing captivating user interfaces, ensuring a superb user experience across various platforms. My proficiency extends to modern JavaScript frameworks such as React, Angular, and Vue.js. On the backend, I excel in architecting scalable and efficient server-side systems, leveraging technologies like Node.js, Python (Django and Flask), Ruby on Rails, and Java. I am driven by a passion for problem-solving and innovation, always striving to create digital experiences that leave a lasting impact.</p>
